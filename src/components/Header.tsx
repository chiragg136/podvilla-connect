    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-1">
          ...
          <Link to="/rooms">
            <Button variant="ghost" className="text-primary-600 hover:text-primary-900">Rooms</Button>
          </Link>
        ...
        {menuOpen && (
          <div className="absolute top-0 left-0 right-0 bg-white shadow-lg p-6 pt-20 z-0 animate-slide-down md:hidden">
            <div className="flex flex-col space-y-4">
              ...
              <Link to="/rooms" className="text-primary-900 font-medium px-4 py-2 hover:bg-gray-100 rounded-md" onClick={() => setMenuOpen(false)}>
                Rooms
              </Link>
